...

{
  ...
  boot.initrd.luks.devices."luks-090b9672-6468-4ca8-b6f6-01ac62fdc644".device = "/dev/disk/by-uuid/090b9672-6468-4ca8-b6f6-01ac62fdc644";
  ...
  # Set your time zone.
  time.timeZone = "America/Coyhaique";
